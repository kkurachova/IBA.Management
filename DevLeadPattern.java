 ...
 */
public class DevLeadPattern {
    private String l_level = "lead";
    private boolean l_teamLead = true;
    private String l_englishLanguageLevel = "C1";
    ...
    private boolean isDotNet = ProgrammingLanguage.isDotNet(true);
    ...
    public DevLeadPattern(String l_level, boolean l_teamLead, String l_englishLanguageLevel,
