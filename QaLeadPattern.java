...
public class QaLeadPattern {
    ...
    private boolean l_isAutomation = Testing.isAutomation(true);
    ...
    public QaLeadPattern(String l_level, boolean l_teamLead, String l_englishLanguageLevel,
